...
```
A Coarse-to-Fine Hybrid Registration and Fusion Framework for Hyperspectral Superresolution via Batch Image Alignment, Kunjing Yang, Minru Bai, Ting Lu, Liang Chen, SIAM J. imaging Sci., 19, 2026
```
